...
%type	<item>
	...
	S3LoadOptions                          "S3 LOAD OPTIONS"
	S3PartitionOptions                     "S3 Partition OPTIONS"
...
%type	<ident>
	...
	S3ServerName                    "S3 Server Name"
	S3HostName                      "S3 Host"
	S3AccessId                      "S3 Id"
	S3AccessKey                     "S3 Key"
	S3ForBucket                     "S3 Bucket"
	S3SerName                       "S3 File Path Name"
	S3Name                          "S3 Name"
...
|	"ALTER" "PARTITION" Identifier S3PartitionOptions
	{
 ...
 *******************************************************************/
CreateTableStmt:
	"CREATE" OptTemporary "TABLE" IfNotExists TableName TableElementListOpt CreateTableOptionListOpt PartitionOpt DuplicateOpt AsOpt CreateTableSelectOpt OnCommitOpt S3LoadOptions
	{
...
CreateServerStmt:
	"CREATE" "S3SERVER" S3ServerName "S3OPTIONS" '(' "S3HOST" S3HostName ',' "S3ID" S3AccessId ',' "S3KEY" S3AccessKey ',' "S3BUCKET" S3ForBucket ')'
	{
